function set-path
    ...
    set mypaths /opt/i3blocks /opt/bin /home/michael/bin /home/michael/scripts  /opt/cxoffice/bin ~/.autojump/bin /usr/games/bin /opt/vmware/bin /home/michael/.cargo/bin /usr/share/gopreload/bin ~/ext-projs/go/bin
