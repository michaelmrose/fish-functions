...
function set-path
  ...
  set buildinpaths  /usr/local/bin /usr/bin /bin /usr/local/sbin /usr/sbin /sbin
  set mypaths /usr/home/michael/.cargo/bin /usr/home/michael/.local/bin /usr/home/michael/scripts
